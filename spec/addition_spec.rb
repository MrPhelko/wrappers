...
module Extended
  describe Number do
    context 'addition' do
      it 'can be added by another number' do
        value = Number.new(10) + Number.new(12)
        value.should == Number.new(22)
      end

      it 'can be added by a ruby number' do
        value = Number.new(10) + 13
        value.should == Number.new(23)
      end
  ...
  describe Money do
    context 'addition' do
      ...
      it 'raise an error if attempt to added to money objects' do
        value = Money.new(12) + Money.new(12)
        value.should == Money.new(24)
      end
